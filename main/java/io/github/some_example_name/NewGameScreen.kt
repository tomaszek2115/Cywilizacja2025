...
class NewGameScreen(private val game: Main) : Screen {
    ...
    init {
        ...
        newGameLabel.setPosition(700f,600f)
        newGameLabel.setAlignment(Align.center) // Wyśrodkowanie tekstu
        newGameLabel.setFontScale(2f) // Ustawienie skali czcionki
